...
import { Plus, FileText, Globe, RefreshCw, Trash2, CheckCircle, AlertTriangle, DatabaseZap } from "lucide-react";
...
export default function KnowledgePage() {
    ...
    const getStatusBadge = (status: KnowledgeItem["status"]) => {
        const variants = {
            indexed: { variant: "success" as const, icon: CheckCircle, text: "Indexed" },
            stale: { variant: "destructive" as const, icon: AlertTriangle, text: "Stale" },
            processing: { variant: "warning" as const, icon: RefreshCw, text: "Processing" }
        };
